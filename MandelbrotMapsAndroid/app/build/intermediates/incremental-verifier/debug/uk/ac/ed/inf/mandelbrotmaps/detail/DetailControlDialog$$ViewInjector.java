...
public class DetailControlDialog$$ViewInjector {
  public static void inject(Finder finder, final uk.ac.ed.inf.mandelbrotmaps.detail.DetailControlDialog target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558469, "field 'applyButton' and method 'onDetailApplyButtonClicked'");
    ...
    view = finder.findRequiredView(source, 2131558470, "field 'defaultsButton' and method 'onDefaultDetailButtonClicked'");
    ...
    view = finder.findRequiredView(source, 2131558471, "field 'cancelButton' and method 'onDetailCancelButtonClicked'");
    ...
    view = finder.findRequiredView(source, 2131558465, "field 'mandelbrotBar'");
    target.mandelbrotBar = (android.widget.SeekBar) view;
    view = finder.findRequiredView(source, 2131558467, "field 'juliaBar'");
    target.juliaBar = (android.widget.SeekBar) view;
    view = finder.findRequiredView(source, 2131558466, "field 'mandelbrotText'");
    target.mandelbrotText = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131558468, "field 'juliaText'");
